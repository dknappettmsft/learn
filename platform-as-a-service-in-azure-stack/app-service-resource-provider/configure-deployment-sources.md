...
2. Browse to **All Services** and select the **App Service**.
    ![App Service Resource Provider Admin](media/app-service-deployment-sources-image1.png)
3. Click **Source control configuration**. You can see the list of all configured deployment sources.
    ![App Service Resource Provider Admin Source Control Configuration](media/app-service-deployment-sources-image2.png)
...
1. Sign in to GitHub, browse to https://www.github.com/settings/developers, and then click **Register a new application**.
    ![GitHub - Register a new application](media/app-service-deployment-sources-image3.png)
...
6. Click **Register application**. A page is displayed listing the **Client ID** and **Client Secret** for the application.
    ![GitHub - Completed application registration](media/app-service-deployment-sources-image4.png)
...
1. Sign in to BitBucket and browse to **Integrations** under your account.
    ![BitBucket Dashboard - Integrations](media/app-service-deployment-sources-image5.png)
2. Click **OAuth** under Access Management and **Add consumer**.
    ![BitBucket Add OAuth Consumer](media/app-service-deployment-sources-image6.png)
...
8. Click **Save**. You now see this new application, along with the **Key** and **Secret**, under **OAuth consumers**.
    ![BitBucket Application Listing](media/app-service-deployment-sources-image7.png)
...
![OneDrive Applications](media/app-service-deployment-sources-image8.png)
...
![OneDrive Application Properties](media/app-service-deployment-sources-image9.png)
...
![OneDrive Application - Add Web Platform](media/app-service-deployment-sources-image10.png)
8. Add the **Microsoft Graph Permissions** - **Delegated Permissions**
    - **Files.ReadWrite.AppFolder**
    - **User. Read**  
      ![OneDrive Application - Graph Permissions](media/app-service-deployment-sources-image11.png)
9. Click **Save**.
...
2. Click **Create app**.
    ...
    ![Dropbox applications](media/app-service-deployment-sources-image12.png)

3. Select **DropBox API**.
4. Set the access level to **App Folder**.
5. Enter a **Name** for your application.
![Dropbox application registration](media/app-service-deployment-sources-image13.png)
...
![Dropbox application configuration](media/app-service-deployment-sources-image14.png)
9.  In a new browser tab or window, sign in to the Azure Stack admin portal (https://adminportal.local.azurestack.external) as the service administrator.
10.  Browse to **Resource Providers** and select the **App Service Resource Provider Admin**.
11. Click **Source control configuration**.
